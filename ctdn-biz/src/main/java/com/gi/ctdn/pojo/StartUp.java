...
public class StartUp {
    ...
    private Integer districtGrandsonId;
    ...
    public Integer getDistrictGrandsonId() {
        return districtGrandsonId;
    }

    public void setDistrictGrandsonId(Integer districtGrandsonId) {
        this.districtGrandsonId = districtGrandsonId;
    }
