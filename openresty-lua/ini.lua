...
function _CONF.redis()
    local  redis_config = {host='10.9.210.204',pass='xhhl-redis',port=6379,db=0} --redis配置项
    return redis_config
end

function _CONF.redis_cache()
    local  redis_config = {host='10.9.210.22',pass='xhhl-redis',port=6385,db=1} --redis配置项
    return redis_config
end
