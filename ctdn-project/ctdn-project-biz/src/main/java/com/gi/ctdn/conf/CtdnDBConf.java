...
public class CtdnDBConf {
    ...
    @Value("${spring.datasource.username.ctdnweb}")
    protected volatile String username;
    @Value("${spring.datasource.password.ctdnweb}")
    protected volatile String password;
    @Value("${spring.datasource.url.ctdnweb}")
