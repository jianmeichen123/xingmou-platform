...
public class EventListedInfoController {
	 ...
	 * @return
	 */
    @RequestMapping("queryProjectEventListed")
    @ResponseBody
	public MessageInfo<List<EventListedInfo>> getListBySourceCode(@RequestBody EventListedInfo eventListedInfo){
		MessageInfo<List<EventListedInfo>> messageInfo = eventListedInfoBiz.getListBySourceCode(eventListedInfo.getSourceCode());
		return messageInfo;
	}
}
