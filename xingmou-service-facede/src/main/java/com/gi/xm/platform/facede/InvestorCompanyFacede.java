...
public interface InvestorCompanyFacede {
		MessageInfo<Integer> deleteInvestorCompany(Long id);
		
    MessageInfo<Long> createInvestorCompany(InvestorCompanyInfo investorCompanyInfo);
		
	MessageInfo<Integer> updateInvestorCompany(InvestorCompanyInfo investorCompanyInfo);
