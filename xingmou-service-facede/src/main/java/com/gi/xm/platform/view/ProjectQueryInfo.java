...
public class ProjectQueryInfo extends QueryInfo {
    ...
    private String searchFields ="id,title,weblink,source_type,ceo_name,company_id,company_name,industry_id,industry_sub_id," +
            ...
            "newest_event_date,newest_event_round,newest_event_round_id,newest_event_money,newest_event_inverstrirm_names,source_id,create_date,status," +
            "business_model,industry_pain_points,team_score,operation_score,score,time_span,invest_info,inverstrirm_names,invest_num,invest_money,source_id,description,code";
