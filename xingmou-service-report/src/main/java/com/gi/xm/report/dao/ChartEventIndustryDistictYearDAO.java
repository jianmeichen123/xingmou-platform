...
*/
	...
	List<ChartEventIndustryDistictYear> selectByYearIndustryId(@Param("years") Integer[] years,@Param("industryId") Integer industryId);

	List<ChartEventIndustryDistictYear> selectDistrictTop10();
